...
public class C05_DateTimeFornatter {
    public static void main(String[] args) {
        /*
        java tarih ve zamani kendi formatinda olusturur.Ancak bizim
        istedigimiz formata uygun olarak cevirmemize veya yazdirmamiza
        izin verir.
         GUN
         ...
         */
        LocalDateTime ldt=LocalDateTime.now(); // 2023-03-09T22:03:10.478183900
        ...
        System.out.println(ldt.format(dtf3)); // Perşembe 22:13
